...
pub fn recommended_move(game_state: &String) -> Option<&'static str> {
    ...
    match game_state_string {
        ...
        "B:W16,18,20,21,22,26,27,28,29,30,31,32:B1,2,3,4,5,6,7,9,11,12,14" => {
            // 11-16 22-18 10-14 25-22 8-11 24-20 16-19 23x16
            Some("14x23")
        },
        "W:W16,20,21,22,26,27,28,29,30,31,32:B1,2,3,4,5,6,7,9,11,12,23" => {
            // 11-16 22-18 10-14 25-22 8-11 24-20 16-19 23x16 14x23
            Some("26x19")
        },
